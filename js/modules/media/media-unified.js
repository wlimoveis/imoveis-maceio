...
const MediaSystem = {
    ...
    // ========== RENDER PDFs - NUMERAÇÃO VISÍVEL, STATUS MENOR ==========
    renderPdfPreviewComplete: function() {
        ...
        for (var idx = 0; idx < allPdfs.length; idx++) {
            ...
            // NÚMERO DE ORDENAÇÃO (canto inferior esquerdo)
            html += '<div style="position:absolute;bottom:2px;left:2px;min-width:16px;height:16px;background:#000000 !important;color:#ffffff !important;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:8px !important;font-weight:bold !important;z-index:95;padding:0 3px;box-shadow:0 1px 2px rgba(0,0,0,0.3);">' + numero + '</div>';
            
            // STATUS (canto inferior direito) - FONTE BEM PEQUENA
            html += '<div style="position:absolute;bottom:2px;right:2px;padding:2px 3px;background:' + statusBgColor + ' !important;color:white !important;border-radius:2px;font-size:0.4rem !important;font-weight:bold !important;z-index:90;white-space:nowrap;box-shadow:0 1px 2px rgba(0,0,0,0.2);">' + statusText + '</div>';
