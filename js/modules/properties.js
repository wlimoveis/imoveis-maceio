...
window.addNewProperty = async function(propertyData) {
    ...
    try {
        ...
        // Aguardar o Support System injetar a UI completa
        setTimeout(() => {
...
// ========== FALLBACK PARA UI DO ADMIN (Substituído pelo Support System em modo debug) ==========
window.loadPropertyList = function(page = 1) {
    ...
    if (container && countElement) {
        ...
        if (totalItems === 0) {
            ...
            container.innerHTML = `
                <div style="background: #e8f4fd; padding: 0.8rem 1rem; border-radius: 8px; margin-bottom: 1rem;">
                ...
                <p style="text-align: center; color: #666; padding: 1rem;">
                    <i class="fas fa-chart-line"></i> Lista detalhada disponível em modo debug (<code>?debug=true</code>)
                </p>
            `;
        }
    }
...
console.log('📋 Fallback loadPropertyList configurado (UI completa no Support System)');
