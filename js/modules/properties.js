...
window.FeatureIconMapper = {
    mappings: [
        ...
        { keywords: ['área privativa', 'area privativa', 'privativa', 'm²', 'm2', 'metros quadrados', 'área', 'area', 'área útil', 'area util', 'área construída', 'com 01 vaga de garagem', 'area construida'], icon: 'fa-home', color: '#6c5ce7', label: 'Área Privativa' },
